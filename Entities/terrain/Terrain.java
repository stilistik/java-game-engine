...
public class Terrain {
	...
	public Terrain(int gridX, int gridZ, TerrainData texturePack){
		this.terrainData = texturePack;
		this.x = gridX * SIZE;
		this.z = gridZ * SIZE;
	...
	public TerrainData getTexturePack() {
		return terrainData;
	}
	...
	public void setHeightValues(float[][] heights){
